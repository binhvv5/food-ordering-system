...
public class OrderPaymentSaga implements SagaStep<PaymentResponse, OrderPaidEvent, EmptyEvent> {
    ...
    private final OrderPaidMessagePublisher orderPaidMessagePublisher;
    ...
    public OrderPaidEvent process(PaymentResponse paymentResponse) {
        ...
        OrderPaidEvent domainEvent = orderDomainService.payOrder(order, orderPaidMessagePublisher);
        orderSagaHelper.saveOrder(order);
        log.info("Order with id: {} is completed!", paymentResponse.getOrderId());
        return domainEvent;
    }
