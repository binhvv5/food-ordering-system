...
public class PaymentMessagingDataMapper {
    ...
    public PaymentResponseAvroModel paymentCompletedEventToPaymentResponseArvoModel(PaymentCompletedEvent paymentCompletedEvent) {
    ...
    public PaymentResponseAvroModel paymentCancelledEventToPaymentResponseArvoModel(
    ...
    public PaymentResponseAvroModel paymentFailEventToPaymentResponseArvoModel(
